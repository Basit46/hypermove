...
export const BottomClaim = ({ text }) => {
  return (
    <div className="w-fit flex flex-col items-end gap-[10px]">
      ...
      <div className="flex justify-center items-center hover:scale-[1.1] duration-500 cursor-pointer">
        <img src={bg} alt="bg" />
...
export const TopClaim = ({ text }) => {
  return (
    <div className="ml-[-70px] mt-[-40px] w-fit flex flex-col  gap-[10px]">
      ...
      <div className="ml-[25px] flex justify-center items-center hover:scale-[1.1] duration-500 cursor-pointer">
        <img src={bg} alt="bg" />
        <p className="absolute">CLAIM</p>
      </div>
    </div>
