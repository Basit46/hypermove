        ...
        <div className="mt-[70px] lg:px-[60px] flex flex-col lg:flex-row justify-between gap-[50px] sm:gap-[100px]">
          <div className="w-full md:w-[50%]">
            ...
            <p className="mt-[10px] opacity-70 font-Montserrat leading-[28px]">
              Welcome to the world’s most unhinged battle royale! Slash, bash,
              and shoot your way through an intense 150-player melee. Earn loot,
              trade items, and maybe, just maybe, you’ll make it to the top.
              Just don’t look down once you do — what you left behind ain’t
              pretty. <br /> We’re taking battle royales to a whole new level
              thanks to our genre-defying story missions! <br /> Off The Grid
              features an immersive 60-hour narrative campaign, which you’ll
              take part in as the battle royale rages on around you. Take on
              jobs for the video game companies, scour Teardrop Island for its
